...
const feedcestinha = (cestinha) => new Promise(resolve => {

  fetch('https://app.diwoapp.com.br/whitela/ws/getprodutoscesta.php', {
      method: 'POST',
      headers: {
...
const FeedCestinhaService = {
  feedcestinha
}

export default FeedCestinhaService
