...
const updatecestinha = (produto) => new Promise(resolve => {
  console.log(produto)
  //status , idpedido, datademodificacao
   fetch('https://app.diwoapp.com.br/whitela/ws/updatecestinhabyid.php', {
      method: 'POST',
...
const UpdateCestinhaService = {
  updatecestinha
}

export default UpdateCestinhaService
